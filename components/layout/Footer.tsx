  ...
  const socialIcons = [
    {
      ...
      link: (
        ...
        >
          <path
            d="M15.1191 14.5799H17.8191L18.8991 10.2599H15.1191V8.09991C15.1191 6.98751 15.1191 5.93991 17.2791 5.93991H18.8991V2.31111C18.547 2.26467 17.2175 2.15991 15.8135 2.15991C12.8813 2.15991 10.7991 3.94947 10.7991 7.23591V10.2599H7.55908V14.5799H10.7991V23.7599H15.1191V14.5799Z"
            fill="#F7F7F8"
          />
        </svg>
      ),
    ...
    },
    {
      ...
      link: (
        ...
        >
          <path
            d="M15.0554 11.2249L23.2575 1.62158H21.3135L14.1936 9.95972L8.50411 1.62158H1.94312L10.5453 14.2317L1.94312 24.3016H3.88712L11.4072 15.4953L17.4157 24.3016H23.9767L15.0554 11.2249ZM12.3937 14.3418L11.5222 13.0863L4.58695 3.09578H7.57261L13.1681 11.1585L14.0397 12.414L21.3151 22.8954H18.3294L12.3937 14.3418Z"
            fill="#F7F7F8"
          />
        </svg>
      ),
        ...
        <div className="flex flex-col w-full lg:w-auto">
          <h2
            ...
            style={{
              ...
              background:
                "linear-gradient(180deg, var(--color-Spotlight-Color-Spotlight-White, #F7F7F8) 0%, var(--color-Spotlight-Color-Dark-Gray, #4A4A5A) 100%)",
              ...
              <li className="flex items-start lg:items-center gap-4 lg:gap-5">
                <span className="flex-none w-8 h-8 lg:w-10 lg:h-10 rounded-full border border-(--spotlight-700) flex items-center justify-center mt-0.5 lg:mt-0">
                  <svg
                    ...
                    width="20"
                    height="20"
                    className="lg:width-24 lg:height=24"
                    viewBox="0 0 24 24"
                    fill="none"
                  >
                    <path
